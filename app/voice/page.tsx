...
export default function VoicePage() {
  ...
  const generateGuidance = (
    ...
    if (duration === 0) {
      return `Welcome to your sauna session. The temperature is ${sauna.temperature.toFixed(2)} degrees with ${sauna.humidity.toFixed(2)} percent humidity. Your current heart rate is ${health.heartRate.toFixed(0)}. Take slow, deep breaths and relax.`;
    }
  ...
  const stopSession = () => {
    ...
    speakGuidance(
      "Session complete. Great work! Remember to rehydrate and cool down gradually.",
    );
  };
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
            ...
            <div className="bg-card border rounded-lg p-6 space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-semibold">
                    {saunaData?.temperature
                      ? saunaData.temperature.toFixed(1)
                      : "--"}
                    °C
                  </span>
                </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex gap-4">
              {!sessionActive ? (
                <Button onClick={startSession} size="lg" className="px-8 py-6">
          ...
          <div className="bg-muted/50 border rounded-lg p-4 text-center">
            <p className="text-xs text-muted-foreground">
              Sauna temperature and humidity are real-time data from your Harvia
              sauna. Health metrics (heart rate, HRV) are pulled from apple
              watch data. Always consult with a healthcare professional before
              starting a sauna routine, especially if you have any medical
              conditions.
            </p>
          </div>
        </div>
